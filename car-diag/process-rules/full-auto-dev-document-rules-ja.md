...
| handoff:handoff_status | enum | Yes | 引継ぎステータス | ready / in-progress / done / blocked / needs-human |
...
| change-request:change_request_status | enum | Yes | 変更要求ステータス | submitted / analyzing / approved / rejected / implemented |
